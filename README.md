...
- Implementing Clean Architecture and SOLID principles for scalable software.
...
| :--- | :--- |
| **Mobile** | Kotlin, Android SDK, Jetpack Compose, Flutter, Dart |
| **Frontend** | Vue.js, JavaScript (ES6+), TypeScript, HTML5, CSS3 |
| **Backend** | Node.js, Express.js, Laravel |
| **Database** | MySQL, PostgreSQL, MongoDB |
| **Tools & DevOps** | Docker, GitHub Actions, Nginx, Git, Linux |
